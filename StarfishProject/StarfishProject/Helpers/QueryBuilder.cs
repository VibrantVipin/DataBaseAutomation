...
namespace StarfishProject.Helpers
{
    public class QueryBuilder
    {
        ...
        //Sort query having search element without join
        ...
        //Sort query having search element with join
        ...
        //Edit row query with id in current table 
        ...
        //insert query to insert a record in given table
        ...
        //update query to update a record in given table
