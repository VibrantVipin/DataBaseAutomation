...
namespace StarfishProject.Controllers
{
    public class AutomateController : Controller
    {
        ...
        //Displaying the Table which is passed in TableName and page number
        //returning the data of that table to view
        ...
        //Searching the Data in TableName and with pagination on the given page number
        //returning the Searched data of that table to view
        [HttpPost]
        ...
        //Searching the Data in TableName,pagination on the given page number and search keyword
        //returning the Searched data of that table to view
        [HttpGet]
        ...
        //Sort the column as ColumnName of given table as tableName with pagination
        //returning the Sortabke data of that table to view
        ...
        //Edit the record having id in current Table 
        ...
        //Delete the record having id in current Table
        //returning to that table's view
        ...
        //add the inserted record in the given table
        ...
        //Update the record having id in current table
